...
class Genesis_Block:
    ...
    def get_hash(self):
        my_hasher = sha256(
            ...
            + str(self.data_dic).encode("utf-8")
    ...
    # amount of values required by the system
    ...
    def ValidateChain(self):
        ...
        while limit >= 1:
            ...
            if current_block_hash != current_block.get_hash():
                ...
                if verbose:
                    print(
                        "[!]INTEGRITY ERROR: hash mismatch at block",
                        self.chain[limit - 1].index,
                        "in the chain",
                    )
                    print(
                        "[-]CURRENT HASH ----> "
    ...
    def GetChainFromFile(self, file_name):
        ...
        try:
            while x <= n:
                ...
                time = str(block.get("time"))

                if index == 0:
                    blockTemplate = Genesis_Block()
                    blockTemplate.time = time
